        ...
        <div className={styles.background}>
            ...
            <article className={styles.History}>
                ...
                <section className={styles.HistoryText}>
                    <p className={styles.textOne}>Добро пожаловать в мир "Нур Принт" – вашего надежного партнера в области рекламы, основанного семейным духом и творческим вдохновением!</p>
                    ...
                    <p className={styles.textSix}> С "Нур Принт" вы не просто получаете рекламные материалы, вы получаете вдохновение, страсть и заботу семьи, которая делает вашу мечту реальностью.</p>

                    <p className={styles.textSeven}>Давайте создадим вместе нечто великолепное – давайте создадим историю успеха с "Нур Принт"!</p>
                </section>
            </article>
