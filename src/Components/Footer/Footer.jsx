...
function Footer() {
  return (
    <footer className={styles.Footer}>
      ...
      <div className={styles.IconsLisence}><a style={{color: "white"}} target="_blank" href="https://icons8.com/icon/59740/bookmark-ribbon">App</a> icon by <a style={{color: "white"}} target="_blank" href="https://icons8.com">Icons8</a></div>
